    ...
    var header: some View {
        HStack {
            ...
            Toggle(isOn: self.$isFirstPlayer.didSet{
                ...
                self.store.send(.squad(action: .updateSquad(self.squadData)))
            }){
                Text("First Player")
...
//
//struct Redux_SquadCardViewModel {
...
//}
//
//struct Redux_IndicatorView: View {
//    let label: String
//    let bgColor: Color
//    let fgColor: Color
//    
...
//}
//
//class Redux_PilotDetailsViewModel: ObservableObject {
...
//}
//
//struct Redux_SimpleFlipper : View {
