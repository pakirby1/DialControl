...
//
// https://medium.com/better-programming/swiftui-multiline-content-fit-textfield-3abbdcedaabc

import Foundation
import SwiftUI

struct MultilineTextView_ContentView: View {
    ...
    var body: some View {
        NavigationView {
            VStack(alignment: .leading) {
                ...
                MultilineTextField("Type here", text: MultilineTextView_ContentView.testBinding, onCommit: {
                    print("Final text: \(MultilineTextView_ContentView.test)")
                })
